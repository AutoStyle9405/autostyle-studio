...
const beforeImages = [
  "/projects/honda-civic/before-1.jpg",
  "/projects/honda-civic/before-2.jpg",
];
const prepImages = [
  "/projects/honda-civic/prep-1.jpg",
  "/projects/honda-civic/prep-2.jpg",
];
const paintImages = [
  "/projects/honda-civic/paint-1.jpg",
  "/projects/honda-civic/paint-2.jpg",
];
...
export default function HondaCivicProject() {
  return (
    <main className="pt-24 bg-autoblack text-white">
      <section className="relative min-h-[75vh] flex items-end px-5 pb-16 overflow-hidden">
        <img
          src="/projects/honda-civic/paint-1.jpg"
          alt="Honda Civic"
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <h1 className="text-5xl md:text-8xl font-black mt-8 mb-6">
            Honda <span className="text-autored">Civic</span>
          </h1>
          <p className="text-xl md:text-2xl text-white/75 max-w-3xl">
            Цялостно възстановяване на боята, подготовка, боядисване и финален професионален финиш.
          </p>
        </div>
      </section>
      <section className="px-5 py-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div className="grid grid-cols-2 gap-4">
            <img
              src="/projects/honda-civic/before-1.jpg"
              alt="Преди"
          ...
          <div className="bg-zinc-950 border border-white/10 rounded-[2rem] p-8 md:p-10">
            <p className="text-autored font-bold mb-3">
              Проект / Цялостно възстановяване
            </p>
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              От увредена боя до завършен финиш
            </h2>
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Автомобилът беше с тежко увредено лаково покритие. Извършихме подготовка,
              шкурене, обработка на дефектите, боядисване и финален финиш за възстановяване
              на визията.
            </p>
            ...
            <ul className="space-y-3 text-white/70 text-lg">
              <li>✓ Премахване на стара и увредена боя</li>
              <li>✓ Шкурене и подготовка</li>
              <li>✓ Кит и изравняване на дефекти</li>
              <li>✓ Грундиране</li>
              <li>✓ Боядисване</li>
              <li>✓ Полагане на лак</li>
              <li>✓ Финален финиш</li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black border border-white/10 rounded-[2rem] p-7">
              ...
              <p className="text-white/60">Оглед на увредената боя и дефектите.</p>
            </div>
            <div className="bg-black border border-white/10 rounded-[2rem] p-7">
            ...
            <div className="bg-black border border-white/10 rounded-[2rem] p-7">
              ...
              <p className="text-white/60">Боядисване, лак и финален резултат.</p>
            </div>
          </div>
