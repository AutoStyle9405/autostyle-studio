...
const beforeImages = ["/projects/golf-5/before-1.jpg"];
const paintImages = ["/projects/golf-5/paint-1.jpg"];
...
export default function Golf5Project() {
  return (
    <main className="pt-24 bg-autoblack text-white">
      ...
      <section className="relative min-h-[75vh] flex items-end px-5 pb-16 overflow-hidden">
        <img
          src="/projects/golf-5/paint-1.jpg"
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <h1 className="text-5xl md:text-8xl font-black mt-8 mb-6">
            Volkswagen <span className="text-autored">Golf 5</span>
          </h1>

          <p className="text-xl md:text-2xl text-white/75 max-w-3xl">
            Локален ремонт на преден калник и броня с подготовка, боядисване и професионален финиш.
          </p>
        </div>
      </section>
      ...
      <section className="px-5 py-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              src="/projects/golf-5/before-1.jpg"
              alt="Golf 5 преди"
          ...
          <div className="bg-zinc-950 border border-white/10 rounded-[2rem] p-8 md:p-10">
            <p className="text-autored font-bold mb-3">
              Проект / Локален ремонт
            </p>

            <h2 className="text-4xl md:text-5xl font-black mb-6">
              От увреден детайл до завършен финиш
            </h2>

            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Автомобилът беше с увредени участъци по предния калник и бронята.
              Извършихме подготовка, шкурене, китосване, боядисване и финален финиш
              за възстановяване на визията.
            </p>
            ...
            <ul className="space-y-3 text-white/70 text-lg">
              <li>✓ Оглед на увредените детайли</li>
              <li>✓ Шкурене и подготовка</li>
              <li>✓ Кит и изравняване на дефекти</li>
              <li>✓ Маскиране на автомобила</li>
              <li>✓ Боядисване</li>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-black border border-white/10 rounded-[2rem] p-7">
              ...
              <p className="text-white/60">
                Оглед на увредения калник и броня преди възстановяване.
              </p>
            </div>
            ...
            <div className="bg-black border border-white/10 rounded-[2rem] p-7">
              ...
              <p className="text-white/60">
                Боядисване, лак и завършен професионален резултат.
              </p>
            </div>
          </div>
